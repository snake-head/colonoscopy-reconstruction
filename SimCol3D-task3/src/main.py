...
# INPUT_PATH = './SyntheticColon_I_Test/ims_082_12'
# OUTPUT_PATH = './SyntheticColon_I_Test/SimCol_submission/RealColon_082/ims_082_12_OP'
...
if __name__ == "__main__":
    ...
    if not os.path.exists(INPUT_PATH):
        ...
        glob.__file__
        input_file_list = np.sort(glob.glob(INPUT_PATH + "/out*.png"))
    ...
    for i in range(len(input_file_list) - 1):
        ...
        ## for the real examples we want to evalute the sequences in both directions:
        #predict_pose(im2_path, im1_path, OUTPUT_PATH + '/pose/')
